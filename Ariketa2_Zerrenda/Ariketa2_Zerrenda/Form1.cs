namespace Ariketa2_Zerrenda
{
    public partial class Form1 : Form
    {
        ...
        private void btnHurrengoa_Click(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    zenbakiak.Add(new Ariketa(double.Parse(textZenb.Text)));
                ...
                case 3:
                    ...
                    textZenb.Text = "(" + zenbakiak[0].zenbakia + " + (2 x " + zenbakiak[1].zenbakia + ") + (3 x " + zenbakiak[2].zenbakia + ") + (4 x " + zenbakiak[3].zenbakia + ")) / 4 = " + Ariketa.Eragiketa(zenbakiak); ;
